...
public class CommonController {
     ...
     */
    @PostMapping("/upload")
    public AjaxResult uploadFile(MultipartFile file, @RequestParam String type) throws Exception
    {
        try
        {
            log.debug("上传类型：{}", type);
            ...
            String suffix = originalFilename.substring(startIndex + 1);
...
//            String url = serverConfig.getUrl() + fileName;
            ...
            log.debug("文件上传：{}", JSON.toJSONString(ajax));
